...
VALUES
  ...
  ((SELECT trait_id FROM traits WHERE name = 'Pure Essence Voltgar'), 0, '???'),
  ((SELECT trait_id FROM traits WHERE name = 'Pure Essence Hozai'), 0, '???'),
  ((SELECT trait_id FROM traits WHERE name = 'Pure Essence Illuginn'), 0, '???'),
  ((SELECT trait_id FROM traits WHERE name = 'Pure Essence Vørst'), 0, '???'),
  ((SELECT trait_id FROM traits WHERE name = 'Pure Essense Sart'), 0, '???'),
  ((SELECT trait_id FROM traits WHERE name = 'Pure Essense Chalchiu'), 0, '???');